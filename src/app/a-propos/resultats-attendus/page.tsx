...
const data = {
    ...
    coordination: {
        ...
        list: "– Des rapports d’avancement , d’audit et financiers sont élaborés",
    },
};
        ...
        <>
            ...
            <Container className={styles.content}>
                <div className={styles.list}>
                    <ol type="I">
                        <li>
                            <h2>{data.developpement.heading}</h2>
                            <ul>
                                {data.developpement.list.map((item) => {
