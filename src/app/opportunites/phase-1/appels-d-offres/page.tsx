...
const AppelsDOffresPhase1 = () => {
  const opportunities = [
    {
      title: "Appel d'offres pour équipements agricoles",
      date: "2024-01-15",
      description: "Appel d'offres pour la fourniture d'équipements agricoles modernes pour les communautés rurales de la Phase I.",
      status: "Ouvert",
      deadline: "2024-03-15"
    },
    {
      title: "Appel d'offres construction centres de santé",
      date: "2024-02-01",
      description: "Appel d'offres pour la construction et réhabilitation de centres de santé dans le cadre de la Phase I.",
      status: "Fermé",
      deadline: "2024-04-01"
    }
  ];
...
export default AppelsDOffresPhase1; 