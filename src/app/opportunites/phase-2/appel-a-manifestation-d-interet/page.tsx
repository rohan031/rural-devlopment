...
const AppelManifestationInteretPhase2 = () => {
  const opportunities = [
    {
      title: "Appel à manifestation d'intérêt - Fournisseurs équipements",
      date: "2024-03-01",
      description: "Appel à manifestation d'intérêt pour identifier des fournisseurs d'équipements pour la Phase II.",
      status: "Ouvert",
      deadline: "2024-05-01"
    }
  ];
    ...
    <>
      ...
      <div style={{
        ...
        <h1 style={{
          ...
          Appel à manifestation d'intérêt - PRISE Phase II
        </h1>
      </div>
...
export default AppelManifestationInteretPhase2; 