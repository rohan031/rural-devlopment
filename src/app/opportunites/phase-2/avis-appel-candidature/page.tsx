...
const AvisAppelCandidaturePhase2 = () => {
  const opportunities = [
    {
      title: "Avis d'appel à candidature - Superviseur de travaux",
      date: "2024-02-20",
      description: "Avis d'appel à candidature pour le recrutement d'un superviseur de travaux pour la Phase II.",
      status: "Ouvert",
      deadline: "2024-04-20"
    }
  ];
    ...
    <>
      ...
      <div style={{
        ...
        <h1 style={{
          ...
          Avis appel candidature - PRISE Phase II
        </h1>
      </div>
...
export default AvisAppelCandidaturePhase2; 