...
import { ReportTableVariantCommunity } from "@/data/reports-table/type";
...
const TableVariantCommunity = ({ heading, data }: ReportTableProps) => {
...
export default TableVariantCommunity;
